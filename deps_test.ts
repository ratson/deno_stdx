...
export * from "https://deno.land/std@0.223.0/testing/bdd.ts";

export { isWindows, osType } from "https://deno.land/std@0.223.0/path/_os.ts";
...
export {
  assertType,
  type IsExact,
} from "https://deno.land/std@0.223.0/testing/types.ts";
